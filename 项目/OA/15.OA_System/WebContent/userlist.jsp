                ...
                <table class="table table-striped table-hover">
					...
					<c:forEach var="user" items="${userList}">
	                    <tr>
	                        ...
	                        <td>${user.email}</td>
	                        <td>
		                        <select class="form-control" onchange="assignRole(this.value,'${user.id}','${user.name}')" >
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog" >
	...
	<script type="text/javascript">
		...
		//重新分配待办人
		function assignRole(rid,id,ename) {
			...
			$.ajax({
			     url:'assignRole',
			     type:'POST',
			     data:{  //转换 ： name = xxxxxx& price=11
			    	 role:rid,
					 id:id,
					 name:ename
			     }, 
			     success:function(result){ /* 回调返回的是json对象 */
			    	 alert(result.msg);
			     }
