...
//        item.setSeller(seller.getNickName());
    ...
    @Override
    public ResultPage findAllGoods(int pageNum,int pageSize) {
        PageHelper.startPage(pageNum,pageSize);
        Page<TbGoods> goodsPage= (Page<TbGoods>) goodsMapper.selectByExample(null);
        ResultPage resultPage = new ResultPage();
        resultPage.setRows(goodsPage.getResult());
