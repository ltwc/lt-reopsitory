...
//    }
    ...
    @PostMapping("/search")
    public  ResultPage findPage(@RequestParam(defaultValue = "1",value = "page",required = false) int pageNum, int rows,String searchEntity) {
        return goodsService.findAllGoods(pageNum,rows);
    }
}
